...
export interface Mutation {
  ...
  RequestRide: ReportMovementResponse;
  ...
  RequestEmailVerification: RequestEmailVerificationResponse;
  ToggleDrivingMode: ToggleDrivingModeResponse;
  UpdateProfile: UpdateProfileResponse | null;
}
